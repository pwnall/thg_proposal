...
We have surveyed recent proposals, namely Software Guard Extensions (SGX)
\cite{mckeen2013innovative} \cite{anati2013sgx} and Trusted Execution
Technology (TXT) \cite{grawrock2009txt}, and find that they leak private data
by exposing the software's memory access patterns to other programs sharing the
