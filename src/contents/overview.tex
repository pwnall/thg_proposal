...
The mainstream operating systems have monolithic kernels (including device
drivers, filesystem code, networking stacks, and video rendering code) run at
ring 0, which is also called kernel mode. In cloud environments, the OS kernels
provided by customers run at ring 0 in VMX non-root mode,
